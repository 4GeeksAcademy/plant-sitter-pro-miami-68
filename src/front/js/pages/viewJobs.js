	...
	return (
		<>
			...
			<div className="row d-flex">
				<h1 className="mb-3 mt-5 diphylleia-regular jobs"><strong>There are __ Job Posts near you!</strong></h1>
				...
				<div class="hero-image mt-5">
					...
					<div className="owner-text row">
						...
						<div className="col-7">
							<h3 className="diphylleia-regular" style={{ fontSize: "3vw" }}><strong>Your Subscription Includes...</strong></h3>
							<h4 className="diphylleia-regular mt-4" style={{ fontSize: "2vw" }}><strong>✔️ Background Check</strong></h4>
							<p className="mb-0" style={{ fontSize: "1.5vw" }}>🌿 Join for $_ upfront plus a low monthly fee</p>
							<p className="mb-4" style={{ fontSize: "1.5vw" }}>🌿 A background check is included with your sign-up fee</p>
							<h4 className="diphylleia-regular mt-3" style={{ fontSize: "2vw" }}><strong>✔️ Access to Apply to Jobs in Your Area</strong></h4>
